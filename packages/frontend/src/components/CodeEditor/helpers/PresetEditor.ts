...
import CodeEditorBlock from "src/components/CodeEditor/components/CodeEditorBlock/CodeEditorBlock.tsx";
import {
  BlockBlockName,
  CustomEditor,
  isBlock,
...
import CodeEditorLine from "src/components/CodeEditor/components/CodeEditorLine/CodeEditorLine.tsx";
...
} from "src/components/CodeEditor/helpers/normalizeEditorContent.ts";
...
export class PresetEditor {
  ...
  renderElement(props: RenderElementProps): React.JSX.Element {
    ...
    if (type === BlockBlockName) {
      return React.createElement(CodeEditorBlock, props);
    }
    return React.createElement(CodeEditorLine, props);
  }

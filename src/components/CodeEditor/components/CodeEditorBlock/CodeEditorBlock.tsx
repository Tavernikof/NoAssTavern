...
import style from "./CodeEditorBlock.module.scss";
import { RenderElementProps } from "slate-react";
import { useCodeEditorContext } from "src/components/CodeEditor/helpers/CodeEditorContext.ts";
...
const CodeEditorBlock: React.FC<Props> = (props) => {
  const { element } = props;
  const codeEditorContext = useCodeEditorContext();
  const { editor } = codeEditorContext;
...
export default observer(CodeEditorBlock) as typeof CodeEditorBlock;
